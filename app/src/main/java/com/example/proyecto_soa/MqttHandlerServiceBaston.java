...
public class MqttHandlerServiceBaston extends Service implements MqttCallback {
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        Thread thread = new Thread(new Runnable() {
            @Override
            public void run() {
                if (topic.equals(configMQTT.TOPIC_OBSTACLE_EMQX) && "BASTON".equals(rol)) {
                    ...
                    sendBroadcast(i);
                }  else if (topic.equals(configMQTT.TOPIC_ALARM_EMQX) && "BASTON".equals(rol)) {
                    String alarm_state = message.toString();

                    if(alarm_state.equals("CANE REL")){
